...
// The worker is served as a web-accessible asset — set it on THIS module's
// GlobalWorkerOptions (the vendored viewer uses the legacy build, a different
// module instance than our own `pdfjs-dist` import).
